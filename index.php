			...
			<div id="top_nav">
				...
				<div class="top_nav_right">
					<div class="login" id="loginUser">
						<a href="Login/Login.php" class="login1">登录</a>&nbsp;
						<a href="Regist/Regist.php" style="margin-left: 8px;" class="login2">注册</a>
						<a href="javascript:;" class="login3" style="display: none">退出</a>
					</div>
		...
		<div id="layout_main_pic">
			<div id="main_pic">
				...
				<div class="banner-pic">
					<ul>
						<li style="background:#E50D58;display:block;">
							<a href="####" title="">
				...
				<div class="show-case">
					<div class="box-all">
						...
						<div class="notice">
							<div class="bg"></div>
							<ul class="list">
								<li class="hot"><a href="####"><i>【足球】</i><em>苏宁足球俱乐部官方旗舰店</em></a></li>
								<li><a href="####"><i>【公告】</i><em>7.8%定期理财热销中</em></a></li>
								<li><a href="####"><i>【公告】</i><em>PPTV 40英寸智能999元抢</em></a></li>
								<li><a href="####"><i>【公告】</i><em>10.26苏宁主场球票开售</em></a></li>
								<li><a href="####"><i>【公告】</i><em>苏宁足球俱乐部定制电视</em></a></li>
							</ul>
						</div>
				...
				<div class="main-col J-domLazy">
					<ul class="prd-list">
						<li>
							...
							<p class="name"><a href="####">七格格OTHERMIX2016秋新款 网纱拼接弹力修身长袖一字领T恤</a></p>
							<p class="price"></p>
						</li>
						<li>
							<p class="face">
							...
							<p class="name"><a href="####">幸福时光 2016秋冬新款男士套装 卫衣套装卫衣男店主风 男士运动套装 开衫套装 XXL 灰色</a></p>
							<p class="price"></p>
						</li>
						<li>
							<p class="face">
						...
						<li>
							...
							<p class="name"><a href="####">2016新款时尚女鞋深口休闲鞋细带鞋花色运动鞋YD5BB4188 粉色 37码</a></p>
							<p class="price"></p>
						</li>
						<li>
							<p class="face">
					...
					<ul class="prd-list">
						...
						<li>
							...
							<p class="name"><a href="####">战地吉普男士长袖T恤 2016秋装针织T恤 圆领青年打底衫 天蓝色 L</a></p>
							<p class="price"></p>
						</li>
					</ul>
				</div>
		...
		<div id="layout_foot">
			...
			<div id="layout_partner">
				...
				<div class="foot_list">
					...
					<p class="ng-copyright">Copyright© 2002-2016 ，电子商务有限公司版权所有 885551号</p>
				</div>
			</div>
...
function removeCookie(key) {
	setCookie(key, ' ', -11);
		...
		if(getCookie("userName")){
			$('.login1').attr('href','javascript:;').html(getCookie("userName")).css({'color':'red','font-weight':'bold'});
			$('.login3').show();
			$('.login2').hide();
		...
		// document.querySelector("#user").innerHTML = cookie.get("username");
